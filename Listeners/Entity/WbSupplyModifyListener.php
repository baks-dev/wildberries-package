...
#[AsEntityListener(event: Events::prePersist, method: 'prePersist', entity: WbSupplyModify::class)]
final class WbSupplyModifyListener
{
    ...
    public function prePersist(WbSupplyModify $data, LifecycleEventArgs $event)
    {
